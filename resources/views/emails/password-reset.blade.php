...
<body style="font-family: Arial, sans-serif; padding: 20px; max-width: 600px; margin: 0 auto;">
    ...
    <p style="font-size: 16px; color: #555;">
        Has solicitado restablecer tu contraseña en VillaDonq. Haz clic en el botón de abajo para crear una nueva contraseña.
    </p>
    ...
    <p style="font-size: 14px; color: #888;">
        Este enlace expira en 12 horas. Si no solicitaste este correo, por favor ignóralo.
    </p>
